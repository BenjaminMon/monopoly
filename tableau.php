  ...
  <center>
    <table>
      ...
      <tr>
        ...
        <td id="38" colspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          3
        </td>
        <!-- CASE 3 DE LA LIGNE DE DROITE -->
        <td id="12" colspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          <p class="Ldroite">9</p>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td id="36" colspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          5
        </td>
        <td class="maison3"></td>
      ...
      <tr>
        ...
        <td id="33" colspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          8
        </td>
        <!-- CASE 8 DE LA LIGNE DE DROITE -->
        <td id="17" colspan="2" class="relative">
      ...
      <tr class="Lbas">
        ...
        <td class="maison6"></td>
        <!-- CASE 3 -->
        <td id="28"rowspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          9
        </td>
        <!-- CASE 4 -->
        ...
        <td class="maison5"></td>
        <!-- CASE 9 -->
        <td id="22" rowspan="2" class="relative">
          <!-- JOUEUR ICI : <img src="Image/joueur1.png" class="joueur1 absolute" alt="J1" />-->
          3
        </td>
        <!-- CASE 10 -->
